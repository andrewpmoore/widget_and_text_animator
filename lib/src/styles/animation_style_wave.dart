...
class AnimationStyleWave extends AnimationStyle{
  @override
  AnimationSettings getSettings(WidgetRestingEffects effects, AnimationController animationController) {
    ...
    _animationSettings.offsetYAnimation = TweenSequence<double>(
      <TweenSequenceItem<double>>[
        TweenSequenceItem<double>(tween: Tween<double>(begin: 0, end: -offset).chain(CurveTween(curve: Curves.easeOut)),weight: 25.0,),
        TweenSequenceItem<double>(tween: Tween<double>(begin: -offset, end: offset).chain(CurveTween(curve: Curves.easeInOut)),weight: 50.0,),
        TweenSequenceItem<double>(tween: Tween<double>(begin: offset, end: 0).chain(CurveTween(curve: Curves.easeIn)),weight: 25.0,),
      ],
